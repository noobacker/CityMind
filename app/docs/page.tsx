...
export default function DocsPage() {
  return (
    <main className="min-h-screen bg-black text-[#e1e7ef] font-mono selection:bg-[var(--accent)] selection:text-black">
      {/* ── HEADER ── */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-black/80 backdrop-blur-md border-b border-white/5 text-[10px] uppercase tracking-[0.2em] text-[#555]">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-2 group">
            <span className="w-2 h-2 bg-[var(--accent)] rounded-full group-hover:animate-ping" />
            <span className="text-white font-bold">CITYMIND / DOCS</span>
          </Link>
        </div>
        <Link href="/dashboard" className="text-[var(--accent)] hover:text-white transition-colors">[ LAUNCH_KERNEL ]</Link>
      </nav>
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <div className="flex flex-col gap-3 ml-4">
                <Link href="#kernel" className="hover:text-[var(--accent)] transition-colors">Neural Kernel</Link>
                <Link href="#sensory" className="hover:text-[var(--accent)] transition-colors">Sensory Grid</Link>
                <Link href="#routing" className="hover:text-[var(--accent)] transition-colors">Edge Routing</Link>
              </div>
            </div>
            <div>
              <div className="text-white mb-4">02_INFOHAZARDS</div>
              <div className="flex flex-col gap-3 ml-4">
                <Link href="#ethics" className="hover:text-[var(--accent)] transition-colors">Safety Filter</Link>
                <Link href="#privacy" className="hover:text-[var(--accent)] transition-colors">Zero-Knowledge</Link>
              </div>
            </div>
            <div>
              <div className="text-white mb-4">03_DATA_SOURCES</div>
              <div className="flex flex-col gap-3 ml-4">
                <Link href="#api-credits" className="hover:text-[var(--accent)] transition-colors">API Credits</Link>
              </div>
            </div>
          </div>
        </aside>
        ...
        <div className="flex-1 max-w-4xl px-8 lg:px-16 py-16 scroll-smooth">
          ...
          >
            ...
            <section id="kernel" className="mb-20 scroll-mt-24">
              <h2 className="text-[var(--accent)] text-sm uppercase tracking-widest mb-6 underline decoration-[var(--accent)]/20 underline-offset-8">01 // Neural Kernel</h2>
            ...
            <section id="sensory" className="mb-20 scroll-mt-24">
              <h2 className="text-[var(--accent)] text-sm uppercase tracking-widest mb-6 underline decoration-[var(--accent)]/20 underline-offset-8">02 // Sensory Grid</h2>
              <p className="text-sm leading-7 text-[#888] mb-6 font-sans">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-[11px] text-[#aaa]">
                <li className="border border-white/5 p-4 bg-white/2 bg-opacity-50">
                  <span className="text-[var(--accent)] block mb-1">ACOUSTIC DENSITY</span>
                  Monitoring noise pollution to predict residential stress spikes via NYC Open Data.
                </li>
                <li className="border border-white/5 p-4 bg-white/2 bg-opacity-50">
                  <span className="text-[var(--accent)] block mb-1">TRANSIT FLOW</span>
                  MTA line-state ingestion via real-time scraping and official alert sync.
                </li>
                <li className="border border-white/5 p-4 bg-white/2 bg-opacity-50">
                  <span className="text-[var(--accent)] block mb-1">ENV_NODES</span>
                  Air Quality Index (AQI) provided by OpenWeatherMap sensors.
                </li>
                <li className="border border-white/5 p-4 bg-white/2 bg-opacity-50">
                  <span className="text-[var(--accent)] block mb-1">CIVIC_VOICE</span>
            ...
            <section id="routing" className="mb-20 scroll-mt-24">
              <h2 className="text-[var(--accent)] text-sm uppercase tracking-widest mb-6 underline decoration-[var(--accent)]/20 underline-offset-8">03 // Edge Routing</h2>
            ...
            <section id="ethics" className="mb-20 scroll-mt-24">
              <h2 className="text-[var(--accent)] text-sm uppercase tracking-widest mb-6 underline decoration-[var(--accent)]/20 underline-offset-8">04 // Safety Filter</h2>
              <p className="text-sm leading-7 text-[#888] font-sans">
            ...
            <section id="privacy" className="mb-20 scroll-mt-24">
              <h2 className="text-[var(--accent)] text-sm uppercase tracking-widest mb-6 underline decoration-[var(--accent)]/20 underline-offset-8">05 // Zero-Knowledge</h2>
              <p className="text-sm leading-7 text-[#888] font-sans">
            ...
            <section id="api-credits" className="mb-32 scroll-mt-24 border-t border-white/5 pt-12">
              <h2 className="text-[var(--accent)] text-sm uppercase tracking-widest mb-8">External_API_Credits</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-sans">
                <div>
                  ...
                  <a href="https://opendata.cityofnewyork.us/" target="_blank" className="text-[10px] text-[var(--accent)] hover:underline">[ opendata.cityofnewyork.us ]</a>
                </div>
                <div>
                  ...
                  <a href="https://data.cityofnewyork.us/City-Government/NYC-Permitted-Event-Information-SAPA/7p5v-9p9v" target="_blank" className="text-[10px] text-[var(--accent)] hover:underline">[ data.cityofnewyork.us ]</a>
                </div>
                <div>
                  ...
                  <a href="https://new.mta.info/" target="_blank" className="text-[10px] text-[var(--accent)] hover:underline">[ new.mta.info ]</a>
                </div>
                <div>
                  ...
                  <a href="https://openweathermap.org/" target="_blank" className="text-[10px] text-[var(--accent)] hover:underline">[ openweathermap.org ]</a>
                </div>
                <div>
                  ...
                  <a href="https://open-meteo.com/" target="_blank" className="text-[10px] text-[var(--accent)] hover:underline">[ open-meteo.com ]</a>
                </div>
              </div>
            </section>
          </motion.div>
      ...
      {/* Footer Line */}
      <div className="fixed bottom-0 left-0 right-0 h-px bg-[var(--accent)]/20 z-50" />
    </main>
  );
}
